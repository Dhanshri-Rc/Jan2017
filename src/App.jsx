...
───────────────────────────────────────────────────────────── */
const NAV = [
  { id: "series", label: "About" },
  { id: "about", label: "Conference" },
    ...
    <header className={`navbar${scrolled ? " scrolled" : ""}`}>
      <div className="navbar-inner">
        ...
        <nav className="nav-links" aria-label="Main navigation">
          ...
          <button className="nav-btn cta" onClick={() => click("submission")}>
            Submit Paper
          </button>
        </nav>
...
function SH({ tag, title, sub, center, light }) {
  ...
  return (
    <div style={{ textAlign: align, marginBottom: 46 }}>
      ...
      {sub && (
        <p
          className={`sub-text ${light ? "light" : "dark"}`}
          style={{
  ...
  const items = [
    {
      ...
      text: "A worldwide network of scholars collaborating across borders to address pressing technological and societal challenges of our era.",
    },
    {
      icon: <Calendar size={21} />,
      title: "Year-Round Series",
      text: "Operating June through March, SIARE hosts a continuous stream of international academic events spanning diverse disciplines.",
    },
    {
      icon: <Users size={21} />,
      title: "Interdisciplinary Community",
      text: "Uniting researchers, technologists, policymakers, and practitioners for cross-sector dialogue and impactful scholarly exchange.",
    },
    {
      icon: <Award size={21} />,
      title: "Publication Excellence",
      text: "Papers considered for Scopus-indexed journals and internationally recognized proceedings with registered ISBNs.",
    },
  ];
  return (
    <section id="series" className="section s-cream2">
      <div className="container">
        <SH
          tag="SIARE Conference Series"
          title="A Global Platform for Academic Excellence"
  ...
  const objs = [
    {
      ...
      title: "Promote",
      desc: "interdisciplinary collaboration across engineering, AI, and social sciences",
    },
    {
      icon: <Leaf size={16} />,
      title: "Encourage",
      desc: "sustainable innovation through evidence-based research and policy dialogue",
    },
    {
      icon: <Globe size={16} />,
      title: "Address",
      desc: "global challenges including climate, health, and digital inequality",
    },
    {
      icon: <Building size={16} />,
      title: "Foster",
      desc: "academia–industry partnerships for translational research impact",
    },
  ];
  return (
        ...
        <div className="g2">
          <div>
            <SH
              ...
              title="Purpose, Vision & Global Reach"
            />
            <p
              style={{
                color: "var(--muted)",
            ...
            >
              ICEAIT 2026 is a premier international academic conference
              fostering rigorous inquiry at the intersection of emerging
              technologies, artificial intelligence, and smart engineering
              systems.
            </p>
            <p
              style={{
            ...
            >
              Anchored in the belief that technology must serve humanity, the
              conference invites contributions bridging theoretical inquiry with
              practical application — from AI-driven healthcare to smart urban
              infrastructure.
            </p>
            <p
              style={{
  ...
  const tracks = [
    {
      ...
      desc: "Deep learning, NLP, computer vision, autonomous systems, and AI ethics across industrial and societal domains.",
    },
    {
      icon: <Zap size={22} />,
      title: "Smart Engineering & IoT Systems",
      desc: "Intelligent sensors, embedded systems, cyber-physical systems, and smart manufacturing for Industry 4.0.",
    },
    {
      icon: <Leaf size={22} />,
      title: "Sustainable Engineering & Green Tech",
      desc: "Renewable energy, carbon-neutral design, circular economy models, and climate-responsive engineering.",
    },
    {
      icon: <Building size={22} />,
      title: "Smart Cities & Infrastructure",
      desc: "Urban intelligence, smart mobility, digital twins, resilient infrastructure, and connected urban ecosystems.",
    },
    {
      icon: <BarChart3 size={22} />,
      title: "Social Impact & Policy Innovation",
      desc: "Technology governance, digital equity, AI policy, SDG-aligned research, and ethics of emerging technologies.",
    },
    {
      icon: <Globe size={22} />,
      title: "Digital Transformation & Society",
      desc: "Digital economies, e-governance, Industry 5.0, human-computer interaction, and societal adaptation to tech.",
    },
  ];
  return (
    <section id="tracks" className="section s-navy">
      <div className="container">
        <SH
          tag="Conference Tracks"
          title="Six Thematic Research Domains"
  ...
  const steps = [
    {
      n: "01",
      label: "Register",
      desc: "Create your author account on the ICEAIT submission portal.",
    },
    {
      n: "02",
      label: "Prepare",
      desc: "Format manuscript per IEEE/APA guidelines (8–10 pages).",
    },
    {
      n: "03",
      label: "Upload",
      desc: "Submit via EasyChair before the deadline.",
    },
    {
      n: "04",
      label: "Peer Review",
      desc: "Double-blind review by international subject experts.",
    },
    {
      n: "05",
      label: "Notification",
      desc: "Acceptance/revision decision sent to corresponding author.",
    },
    {
      n: "06",
      label: "Camera-Ready",
      desc: "Submit final version with signed copyright form.",
    },
  ];
  return (
      ...
      <div className="container">
        ...
        <div className="g2" style={{ marginBottom: 50 }}>
          <div className="card" style={{ padding: 30 }}>
            ...
            {[
              ["Format", "IEEE or APA citation style"],
              ["Length", "8–10 pages including references"],
              ["Font", "Times New Roman, 12pt"],
              ["Spacing", "1.5 line spacing"],
              ["Language", "English only"],
              ["Scope", "Original, unpublished work"],
            ].map(([k, v]) => (
              <div
                key={k}
                style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            >
              <div style={{ display: "flex", gap: 13 }}>
                ...
                />
                <div>
                  <h3 style={{ fontSize: "1rem", marginBottom: 9 }}>
                    Plagiarism Policy
                  </h3>
                  <p
                    style={{
                  ...
                  >
                    All manuscripts screened via iThenticate. Submissions
                    exceeding the threshold are immediately rejected without
                    review.
                  </p>
                  <div
                    style={{
            ...
            <div className="card" style={{ padding: 22 }}>
              ...
              >
                Each submission must include a structured abstract of 250–300
                words with 5–7 keywords aligned with ACM/IEEE Computing
  ...
  return (
    <section id="registration" className="section s-cream">
      <div className="container">
        <SH
          tag="Registration"
          title="Conference Registration Categories"
          sub="Select the category that best represents your participation. All registrations include access to the full programme."
          center
        />
        <div className="g4">
          {tiers.map((t) => (
            <div key={t.label} className={`tier${t.feat ? " feat" : ""}`}>
              {t.feat && (
                <span
                  ...
                  style={{ marginBottom: 13, display: "inline-block" }}
                >
                  Most Popular
                </span>
              )}
              ...
              <button
                ...
                style={{
                  ...
                  background: t.feat
                    ...
                    : "transparent",
                  color: t.feat ? "var(--navy)" : "var(--gold)",
                  border: t.feat ? "none" : "1.5px solid var(--gold)",
                }}
              >
                Register
              </button>
            ...
            {[
              {
                ...
                desc: "Selected papers invited for submission to affiliated Scopus-indexed international journals post-conference.",
              },
              {
                icon: <FileText size={19} />,
                title: "Conference Proceedings (ISBN)",
                desc: "All accepted and presented papers published in official proceedings with a registered ISBN.",
              },
              {
                icon: <Award size={19} />,
                title: "Extended Journal Publications",
                desc: "Outstanding papers offered fast-track extended journal publication with dedicated editorial support.",
              },
            ].map((p) => (
              <div key={p.title} style={{ display: "flex", gap: 13 }}>
                ...
                <div>
                  <h5 style={{ fontSize: "0.93rem", marginBottom: 6 }}>
                    {p.title}
                  </h5>
                  <p
                    style={{
...
function Dates() {
  const events = [
    ...
    {
      date: "01 June 2026",
      label: "Review Notification to Authors",
      icon: <Send size={18} />,
      hi: false,
    },
    {
      date: "15 June 2026",
      label: "Camera-Ready & Registration Deadline",
      icon: <CheckCircle size={18} />,
      hi: false,
    },
    {
      date: "25–27 Aug 2026",
      label: "Conference Days — Boston, MA, USA",
    ...
    <section id="dates" className="section s-navy2">
      <div className="container" style={{ maxWidth: 800 }}>
        <SH
          ...
          sub="Plan your participation accordingly. All deadlines are at 23:59 AoE (Anywhere on Earth)."
          center
          light
        />
        <div style={{ position: "relative" }}>
          ...
          {events.map((e) => (
            <div
              key={e.date}
              style={{ display: "flex", gap: 18, marginBottom: 14 }}
            >
...
function Committee() {
  const groups = {
    "Chief Patron": [
      {
        name: "Prof. Dr. William H. Ashford",
        role: "Vice-Chancellor, Cambridge Institute of Technology",
      },
      {
        
        name: "Prof. Dr. Anika R. Mehta",
        role: "Dean, School of AI & Smart Systems, MIT Global",
      },
       {
        
        name: "Prof. Dr. Sanika R Shrama",
        role: "Dean, School of AI & Smart Systems, MIT Global",
      },
    ],
    // "Conference Chair": [
    ...
    "Organizing Committee": [
      {
        name: "Dr. James O. Fitzgerald",
        role: "Dept. of Computer Engineering, Stanford University",
      },
      {
        name: "Dr. Priya Subramaniam",
        role: "AI Research Lab, University of Edinburgh",
      },
      {
        name: "Dr. Carlos A. Rivera",
        role: "School of Smart Systems, ETH Zurich",
      },
      {
        name: "Dr. Faisal Al-Mansoori",
        role: "Dept. of Digital Innovation, KAUST",
      },
    ],
    "Technical Committee": [
      {
        name: "Prof. Yuki Tanaka",
        role: "Institute of Robotics, University of Tokyo",
      },
      {
        name: "Dr. Olumide Adeyemo",
        role: "AI Ethics Lab, University of Cape Town",
      },
      {
        name: "Dr. Sanjana Krishnan",
        role: "Centre for IoT Research, IIT Bombay",
      },
      {
        name: "Dr. Lena Hoffmann",
        role: "Green Technologies Institute, TU Berlin",
      },
    ],
  };
  return (
      ...
      <div className="container">
        ...
        <div className="g2">
          <div>
            ...
            >
              For inquiries about paper submissions, registrations, or
              conference logistics, please reach out through any channel below.
              Our organizing team aims to respond within 48 hours.
            </p>
            {[
              {
                icon: <Mail size={17} />,
                label: "Email",
                val: "iceait2026@siare.org",
              },
              {
                icon: <Phone size={17} />,
                label: "Phone",
              ...
              },
              {
                icon: <MapPin size={17} />,
                label: "Venue",
                val: "Grand Academic Hall, International Conference Centre, Boston, MA, USA",
              },
            ].map((c) => (
              <div
                key={c.label}
                style={{ display: "flex", gap: 13, marginBottom: 20 }}
              >
                <div
                  style={{
                    color: "var(--gold)",
      ...
      <div style={{ maxWidth: 1160, margin: "0 auto" }}>
        <div className="footer-g" style={{ marginBottom: 34 }}>
          <div>
            ...
            >
              International Conference on Emerging Technologies, Artificial
              Intelligence, and Smart Engineering Systems. August 2026 · Boston,
              USA.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.42)", fontSize: "0.84rem" }}>
              Boston, MA, USA
            </p>
          </div>
        </div>
        ...
        >
          <p style={{ color: "rgba(255,255,255,0.2)", fontSize: "0.76rem" }}>
            © 2026 ICEAIT · SIARE Conference Series. All rights reserved.
          </p>
          <p style={{ color: "rgba(255,255,255,0.2)", fontSize: "0.76rem" }}>
            Part of the SIARE Global Academic Initiative
          </p>
        </div>
      </div>
    </footer>
